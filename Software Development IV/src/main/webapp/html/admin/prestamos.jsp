...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../css/numeroDePrestamos.css">
...
<nav id="nav">
    ...
    <ul class="nav">
        ...
        <li>
            ...
            <ul>
                <li><a href="prestamos.jsp" class="here">Prestamos realizados</a></li>
        ...
        <section class="tabla">
            ...
            <div class="display">
                <div class="tablain">
                    <table>
                        <tr>
                            <td><h2>Bryan Sanchez</h2></td>
                            <td><h2>Fecha de Peticion: 18/09/2023</h2></td>
                        </tr>
                        <tr>
                            <th><img src="../../imagenes/portada.jpg" class="img"></th>
                            <td ><h4>libro 1</h4></td>
                        </tr>
                        <tr>
                            <th><img src="../../imagenes/portada.jpg" class="img"></th>
